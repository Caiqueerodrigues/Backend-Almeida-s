...
public class TablesService {
    ...
    public ResponseDTO getTablesClientService(Long idClient) {
        try {
            ...
            log.error("ERRO ao obter as tabelas " + e);
            throw new RuntimeException("Erro ao obter as tabelas, tente novamente.");
        }
    }
    ...
    public ResponseDTO createUpdateTableService(CreateTableDTO dados) {
        try {
            ...
            log.error("ERRO ao cadastrar a tabela " + e);
            throw new RuntimeException("Erro ao cadastrar a(s) tabela(s), tente novamente.");
        }
    }
    ...
    private void updateTable(DinamicTableDTO table, CreateTableDTO dados) {
        try {
            ...
            log.error("ERRO ao alterar a tabela " + e);
            throw new RuntimeException("Erro ao alterar a(s) tabela(s), tente novamente.");
        }
    }
